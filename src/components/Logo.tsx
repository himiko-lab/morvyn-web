 ...
 *
 * Transform tiap bentuk sudah diratakan dari tiga lapis <g> bersarang di
 * berkas asal. Kalau logonya diganti lagi, ratakan di `public/logo-morvyn.svg`
 * lebih dulu, buktikan hasil rendernya identik dengan berkas asal, baru salin
 * angkanya ke sini. Jangan menyalin bersarangnya mentah-mentah: nilai di sini
 * dipakai juga oleh favicon dan gambar Open Graph, dan ketiganya harus sama.
 */
export function Logo({ className = "", markOnly = false }: LogoProps) {
  return (
    <span className={`inline-flex items-center gap-2.5 ${className}`}>
      <svg
        viewBox="0 0 10468 9226"
      ...
      >
        ...
        <g transform="translate(-3099.67909,-23623)">
          <path
